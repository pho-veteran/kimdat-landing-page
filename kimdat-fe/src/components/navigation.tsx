...
export function MobileNavigation({ isOpen, onClose }: MobileNavigationProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <nav 
        className={`fixed top-0 right-0 h-full w-80 bg-gradient-to-b from-white to-gray-50/80 backdrop-blur-md shadow-2xl z-50 transform transition-all duration-300 ease-out md:hidden ${
            ...
            <div className="space-y-1 px-4">
              ...
              <div className="space-y-1">
                <button 
                  ...
                  className={`group w-full flex items-center gap-4 px-4 py-3.5 font-medium rounded-xl transition-all duration-200 hover:translate-x-1 ${
                    showProducts 
                ...
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  showProducts ? 'max-h-32 opacity-100' : 'max-h-0 opacity-0'
                }`}>
